                  ...
                  <div className="space-y-2 max-w-lg">
                    <div className="bg-white/[0.04] border border-white/[0.08] text-zinc-200 rounded-2xl rounded-tl-xs p-4 text-sm leading-relaxed">
                      ...
                      <ul className="mt-2 space-y-1 text-xs text-zinc-400">
                        <li>â€¢ <strong className="text-zinc-200">Stage 1:</strong> Implement your hybrid recommendation pipeline with vector embeddings.</li>
                        <li>â€¢ <strong className="text-zinc-200">Stage 2:</strong> Package model inference behind your asynchronous FastAPI gateway.</li>
                      </ul>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 pt-1">
                      ...
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-500/25 text-[11px] text-emerald-300 font-mono">
                        ...
                        <span>Relation: User â†’ using â†’ PyTorch</span>
                      </span>
                    </div>
                  </div>
                </div>
